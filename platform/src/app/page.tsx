  ...
  return (
    <PublicChrome>
      <section className="mx-auto grid max-w-6xl items-center gap-10 px-5 pb-8 pt-16 lg:grid-cols-2">
        <div>
          <PatentBadge />
          <h1 className="mt-6 font-display text-4xl font-semibold leading-[1.08] tracking-tight text-[#F3EFE6] md:text-6xl">
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            <Link href="#fragmentation" className="rounded-sm bg-ember px-4 py-2.5 text-sm font-medium text-graphite-950">
              Explore Qorvex
            </Link>
            <Link
              href="/technology"
              className="rounded-sm border border-white/10 px-4 py-2.5 text-sm text-[#F3EFE6] hover:border-ember/40"
            >
              View Technology
            </Link>
          </div>
      ...
      <section id="fragmentation" className="mx-auto max-w-6xl px-5 py-20">
        ...
        <h2 className="mt-3 max-w-3xl font-display text-3xl font-semibold text-[#F3EFE6] md:text-4xl">
      ...
      <section className="mx-auto max-w-6xl px-5 py-16">
        ...
        <h2 className="mt-3 font-display text-3xl font-semibold text-[#F3EFE6]">Scan → Analyze → Route → Execute → Verify</h2>
      ...
      <section className="mx-auto max-w-6xl px-5 py-16">
        ...
        <h2 className="mt-3 font-display text-3xl font-semibold text-[#F3EFE6]">Two sides. One router. No trend bet.</h2>
        <p className="mt-3 max-w-2xl text-sm text-graphite-400">
      ...
      <section className="mx-auto max-w-6xl px-5 py-16">
        <div className="flex flex-wrap items-end justify-between gap-3">
          <div>
            ...
            <h2 className="mt-3 font-display text-3xl font-semibold text-[#F3EFE6]">Costed prints, not promised yield.</h2>
          </div>
          <SimBadge />
        </div>
        <p className="mt-3 max-w-2xl text-sm text-graphite-400">
      ...
      <section className="mx-auto max-w-6xl px-5 py-16">
        ...
        <h2 className="mt-3 font-display text-3xl font-semibold text-[#F3EFE6]">CEX. DEX. Chains. Pools.</h2>
        <p className="mt-3 max-w-2xl text-sm text-graphite-400">
      ...
      <section className="mx-auto max-w-6xl px-5 py-16">
        ...
        <h2 className="mt-3 font-display text-3xl font-semibold text-[#F3EFE6]">Modular services, one ledger.</h2>
        <div className="mt-8 grid gap-px bg-white/[0.08] md:grid-cols-3">
          {STACK.map(([t, b]) => (
            <article key={t} className="bg-graphite-950 p-6">
              <h3 className="font-display text-lg text-[#F3EFE6]">{t}</h3>
      ...
      <section className="mx-auto max-w-6xl px-5 py-16">
        ...
        <h2 className="mt-3 font-display text-3xl font-semibold text-[#F3EFE6]">A 12-month license. Monthly payment options.</h2>
        <p className="mt-3 max-w-2xl text-sm text-graphite-400">
