                ...
                <ul class="menu-nav nav">
                    ...
                    <li class="nav-item">
                        ...
                        <div class="sidemenu-icon menu-icon">
                            ...
                            <span class="sidemenu-label">Portfolios</span>
                            <i class="angle fe fe-chevron-right"></i></a>
                        <ul class="nav-sub">
                          
                            <li class="nav-sub-item">
                                <a class="nav-sub-link" href="view-portfolio">Manage Portfolios</a>
                            </li>
                            <li class="nav-sub-item">
                                <a class="nav-sub-link" href="package">Packages</a>
                            </li>
                    ...
                    <li  class="nav-item"><a class="nav-link " href="javascript:;" id="terminalLink"> <div class="sidemenu-icon menu-icon">
