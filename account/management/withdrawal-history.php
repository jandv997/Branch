							...
							<div class="card custom-card overflow-hidden">
                                ...
                                <ul class="pagination">
									...
									<div class="table-responsive">
                                        ...
                                        $get_funds = mysqli_query($mysqli,"SELECT * FROM withdrawal WHERE status=1 ORDER BY id DESC LIMIT $offset, $no_of_records_per_page");
                                            $i=0;
