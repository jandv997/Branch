							...
							<ul class="side-menu">
								...
								<li class="slide">
									...
									<ul class="slide-menu">
										...
										<li><a class="slide-item" href="<?php echo $isActiveMember ? 'marketplace' : 'javascript:void(0);'; ?>">Make Purchase</a></li>
										<li><a class="slide-item" href="<?php echo $isActiveMember ? 'active-purchase' : 'javascript:void(0);'; ?>">Active Purchase</a></li>
										<li><a class="slide-item" href="<?php echo $isActiveMember ? 'expire-purchase' : 'javascript:void(0);'; ?>">Expired Purchase</a></li>
