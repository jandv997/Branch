                                ...
                                <div class="card-body">
                                    ...
                                    <form method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            <label for="firstname" class="center-align">Withdrawal Method Name</label>
                                            <input name="name" id="exampleInputName" class="form-control"
                                                placeholder="Enter method name" type="text" required>

                                        </div>

                                        <div class="form-group">
                                            <label for="lastname" class="center-align">Fixed Charge</label>
                                            <input name="charge" class="form-control" id="exampleInputName"
                                                placeholder="Enter charge" type="number" required>

                                        </div>

                                        <div class="form-group">
                                            <label for="lastname" class="center-align">Minimum Amount</label>
                                            <input name="min_amount" class="form-control" id="exampleInputName"
                                                placeholder="Enter amount" type="number" required>

                                        </div>

                                        <div class="form-group">
                                            <label for="lastname" class="center-align">Maximum Amount</label>
                                            <input name="max_amount" class="form-control" id="exampleInputName"
                                                placeholder="Enter amount" type="number" required>
                                        ...
                                        <div class="form-group">
                                            <button type="submit" class="btn btn-info" value=""
                                                name="add-withdrawal">Add Withdrawal Method</button>
                                        </div>
