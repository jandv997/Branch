			...
			<div class="main-container container-fluid">
				<div class="inner-body">
					...
					<div class="page-header">
						...
						<div class="d-flex">
                        <a class="btn btn-info m-2 pull-right" style="color:white" href="javascript:;"
                                    data-bs-target='#create' data-bs-toggle='modal'>Create Investment Porfolio</a>
						</div>
					</div>
					<!-- End Page Header -->
                                ...
                                <ul class="pagination">
									...
									<div class="table-responsive">
                                        ...
                                        if(isset($_GET['userid'])){
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="btn btn-primary" href="javascript:;"
                                                        data-bs-target='#port<?php echo $row['id']; ?>'
                                                        data-bs-toggle='modal'>Adjust Protfolio </a>

                                                    <a class="btn btn-danger" href="javascript:;"
                                                        data-bs-target='#delete<?php echo $row['id']; ?>'
                                                        data-bs-toggle='modal'>Delete Protfolio </a>
                                                </td>
                                            ...
                                            <!-- Default Size -->
                                            <div class="modal fade" id="port<?php echo $row['id']; ?>" tabindex="-1"
                                                role="dialog">
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h4 class="title" id="defaultModalLabel">
                                                                Update <?php echo $row['name']; ?> for
                                                                <?php echo $user['email']; ?>
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-12 form-group">
                                                                        ...
                                                                        <select name="investmentid"
                                                                            onchange="changename('idname<?php echo $row['id']; ?>', 'investmentid<?php echo $row['id']; ?>')"
                                                                            class="form-control mb-3"
                                                                            id="investmentid<?php echo $row['id']; ?>"
                                                                            required>
                                                                            ...
                                                                            while($in = mysqli_fetch_assoc($getinvest)){ 
                                                                                ...
                                                                                ?>
                                                                            <option
                                                                                <?php if($row['investmentid']==$in['id']){ echo 'selected'; } ?>
                                                                                value="<?php echo $in['id']; ?>">
                                                                                <?php echo $in['name']." ".$in['percent']."% || ".$in['compound_percent']."%"; ?></option>
                                                                            <?php } ?>
                                                                    ...
                                                                    <div class="col-12 form-group">
                                                                        ...
                                                                        <input type="text" class="form-control"
                                                                            name="daily_roi"
                                                                            value="<?php echo $row['daily_roi']; ?>"
                                                                            placeholder="Enter Daily roi ">
                                                                    </div>


                                                                    <div class="col-12 form-group">
                                                                        <label>Profit Gotton Roi</label>
                                                                        <input type="text" class="form-control"
                                                                            name="added_roi"
                                                                            value="<?php echo $row['added_roi']; ?>"
                                                                            placeholder="Enter Profit roi ">
                                                                    </div>

                                                                    <div class="col-12 form-group">
                                                                        <label>Payout </label>
                                                                        <select name="payout" class="form-control mb-3"
                                                                            id="payout" required>
                                                                            <option value="">Select Payout</option>
                                                                            <option
                                                                                <?php if($row['payout']=="1"){ echo 'selected'; } ?>
                                                                                value="1">Daily Payout</option>

                                                                            <option
                                                                                <?php if($row['payout']=="5"){ echo 'selected'; } ?>
                                                                                value="5">6 Months</option>
                                                                            <option
                                                                                <?php if($row['payout']=="6"){ echo 'selected'; } ?>
                                                                                value="6">7 Months</option>
                                                                            <option
                                                                                <?php if($row['payout']=="7"){ echo 'selected'; } ?>
                                                                                value="7">8 Months</option>
                                                                            <option
                                                                                <?php if($row['payout']=="8"){ echo 'selected'; } ?>
                                                                                value="8">9 Months</option>
                                                                    ...
                                                                    <div class="col-12 form-group">
                                                                        <label>Duration (Number of Days left) </label>
                                                                        <input type="text" class="form-control"
                                                                            name="duration"
                                                                    ...
                                                                    <div class="col-12 form-group">
                                                                        ...
                                                                        <select name="can_reinvest"
                                                                            class="form-control mb-3" id="can_reinvest"
                                                                            required>
                                                                            <option value="">Select Option</option>
                                                                            <option
                                                                                <?php if($row['can_reinvest']=="1"){ echo 'selected'; } ?>
                                                                                value="1">Yes </option>
                                                                            <option
                                                                                <?php if($row['can_reinvest']=="0"){ echo 'selected'; } ?>
                                                                                value="0">No</option>
                                                                    ...
                                                                    <div class="col-12 form-group">
                                                                        ...
                                                                        <select name="auto_reinvest"
                                                                            ...
                                                                            <option value="">Select Option</option>
                                                                            <option
                                                                                <?php if($row['auto_reinvest']=="1"){ echo 'selected'; } ?>
                                                                                value="1">Yes </option>
                                                                            <option
                                                                                <?php if($row['auto_reinvest']=="0"){ echo 'selected'; } ?>
                                                                                value="0">No</option>
                                                                    ...
                                                                    <div class="col-12 form-group">
                                    <label>Show Action(Withdraw/Re-initate) Buttons </label>
                                    <select name="can_restart" class="form-control mb-3" id="can_restart" required>
                                        <option value="">Select Option</option>
                                        <option value="1" <?php if($row['can_restart']=="1"){ echo 'selected'; } ?> >Yes
                                        </option>
                                        <option value="0" <?php if($row['can_restart']=="0"){ echo 'selected'; } ?>>No
                                        </option>
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <h4>Are you sure you want to delete this porfolio?</h4>
                                                            ...
                                                            <form method="POST" style="padding:10px">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-12">
                                                                        ...
                                                                        <button type="submit" name="delete-port"
                                                                            class="btn btn-primary  btn-block">Yes
                                                                        </button>
