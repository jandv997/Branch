...
// Default to dark theme if no theme option is yet stored
if (!localStorage.nowalightMode && !localStorage.nowadarkMode && !localStorage.nowatransparentMode
    && !localStorage.nowaprimaryColor && !localStorage.nowadarkPrimary && !localStorage.nowatransparentPrimary
    && !localStorage.nowatransparentBgImgPrimary && !localStorage.nowatransparentBgColor && !localStorage.nowaBgImage) {
    body?.classList.remove('light-theme');
    body?.classList.remove('transparent-theme');
    body?.classList.add('dark-theme');
    $('#myonoffswitch2').prop('checked', true);
