...
<html lang="en">
	<head>
		...
		<!-- Title -->
		<title>Withdrawal History | Quantum Scalp </title>
				...
				<div class="main-container container-fluid">
					...
					<div class="breadcrumb-header justify-content-between">
						<div class="left-content">
						  <span class="main-content-title mg-b-0 mg-b-lg-1">Withdrawal History</span>
						</div>
									...
									<div class="card-body">
										...
										<div class="table-responsive  export-table">
											<table id="file-datatable" class="table table-bordered text-nowrap key-buttons border-bottom">
												...
												<th class="border-bottom-0">Withdrawal Method</th>
												<th class="border-bottom-0">Date</th>
												<th class="border-bottom-0">Amount Paid</th>
												
												<th class="border-bottom-0">Credited Amount</th>
												<th class="border-bottom-0">Wallet Address</th>
												<th class="border-bottom-0">Withdrawal Wallet</th>
                                        ...
                                        $get_funds = mysqli_query($mysqli,"SELECT * FROM withdrawal WHERE status=1 and userid='".$rows['id']."' ORDER BY id DESC");
                                            $i=0;
