...
<head>
    ...
    <!-- Title -->
    <title> Quantum Scalp | Sign Up </title>
                                ...
                                <div class="wd-100p">
                                    ...
                                    <div class="">
                                        <div class="main-signup-header">
                                            <h2>Sign Up !</h2>
                                            <h6 class="font-weight-semibold mb-4">Business Account</h6>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <div class="mb-3  step step1 ">
                                                    ...
                                                    <p class="text-muted mt-2">Type in your email address. <br />This
                                                        will be used when you log into Quantum Scalp</p>
                                                    ...
                                                    <input type="text" class="form-control" name="refer" value="<?php if(isset($_GET['refer'])){ echo$_GET['refer']; } ?>"
                                                ...
                                                <div class="mb-3 step step3" style="display:none">
                                                    ...
                                                    <p class="text-muted mt-2">
                                                        ...
                                                        Please fill in your Goverment Business name as it appears on
                                                        your
                                                ...
                                                <div class="mb-3 step step3" style="display:none">
                                                    <label for="username" class="form-label">Business Location</label>
                                                    <input type="text" class="form-control" name="address"
                                                        placeholder="Enter Address" required>
                                                    <div class="invalid-feedback">
                                                        Please Enter bussiness Location
                                                    </div>
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <div class="mb-3 step step4" style="display:none">
                                                    ...
                                                    <label for="username" class="form-label">Business Phone Number
                                                    </label>
                                                ...
                                                <div class="mb-3 step step5" style="display:none">

                                                    <h5 class="mb-0">Lets get to know you</h5>
                                                    <p class="text-muted mt-2">Kindly upload a valid Government Registration </p>


                                                    <label for="username" class="form-label">Select Certificate of
                                                        Incorporation</label>
                                                    <input type="file" class="form-control" id="idcard" placeholder=""
                                                ...
                                                <div class="mb-3 step step5" style="display:none" id="content">
...
$reg = mysqli_query($mysqli,"INSERT INTO `users`(firstname, `address`, email, password, phone, idcard, 2fa_key, 2fa_link, referal_link, referred, refer_date, country, img) VALUES('$firstname',  '$address', '$email', '$hashpassword', '$phone',  '$idcard', '$secret', '$two_fa_link', '$code', '$refer', '$date', '$country', 'img/profile.png' ) ");
