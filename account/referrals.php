										...
										<?php
											...
											<div class="col-md-12 col-lg-12 col-xl-6 col-xxl-4">
												<div class="border d-flex p-2 br-5 mb-2">
													...
													<div>
														<h6 class="mt-1 mb-1"> <?php echo $row['firstname']."  ".$row['lastname'] ; ?></h6>
														<p class="mb-0 text-muted"><?php echo $row['email']; ?></p>

														<?php $check =mysqli_query($mysqli,"SELECT * FROM investment WHERE userid='".$row['id']."' ");  ?>
                                                <td><?php if(mysqli_num_rows($check) > 0 ){ ?>
                                                    <span class="badge bg-success">Funded</span>
													<?php 
                                                }else{ 
													?>
                                                 <span class="badge bg-danger">Pending Funding</span>
